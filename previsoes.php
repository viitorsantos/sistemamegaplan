                   ...
                   <?php include "include/cabecalho.php" ?>
                    ...
                    <div class="col-md-10 corpo">
                        <div class="page-header">                            
                            <div class=" col-md-10 titulo_tela" >Churn Rate e  MRR Churn Rate</div>
                        ...
                        <?php endif; ?>
                        <div class="conteudo">
                            <form method="POST" action="churn.php" target="_blank">
								<div class="row">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group" style="text-align: center">
										 <input type="submit" name="btnacao" value="Mostrar" class="btn btn-info">
									</div>
								</div>
							</div>	
                            </form> 
